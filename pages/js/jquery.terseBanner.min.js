...
!(function (a, b) {
  'function' == typeof define && define.amd
    ...
    ? (module.exports = b(a, document))
    : ((a.terseBanner = a.terseBanner || {}), (a.terseBanner.Global = b(a, document)));
})(window, function (a, b) {
  var c = {
  ...
  (function (a, b) {
    'function' == typeof define && define.amd
      ...
      : 'undefined' != typeof exports
      ? (module.exports = b(a, document))
      : ((a.terseBanner = a.terseBanner || {}), (a.terseBanner.Banner = b(a, document)));
  })(window, function (a, b) {
    function c(a, b) {
  ...
  (function (a, b) {
    'function' == typeof define && define.amd
      ? define(['global', 'banner', 'default-style', 'add-element'], function (c, d) {
      ...
      : ((a.terseBanner = a.terseBanner || {}),
        b($, a, document, a.terseBanner.Global, a.terseBanner.Banner));
    ...
    e.prototype.init = function () {
      (this.$list = this.$elem.children().first()),
        ...
        (this.isHovered = !1),
        (this.isAnimated = !1),
        d.isSupportTouch && (this.options.animation = 'slide');
      var a = this,
        b = this.$elem,
        c = this.$list,
        e = this.$item,
      ...
      if (
        ...
        b.css({ tapHighlightColor: 'transparent', userSelect: 'none' }),
        c.width(2 * a.len * 100 + '%').wrap('<div class="tb-list"/>'),
        f.adaptive &&
          ('none' === b.css('maxWidth') && b.css('maxWidth', '100%'),
          setTimeout(function () {
            c.height(b.height());
          }, 50),
          e.each(function () {
            ...
            a.css({ display: 'block', maxWidth: '100%' }),
              a.attr('data-src') && $(this).data('origin', b),
              $(this).data('thumb', b);
          })),
        f.adaptive ||
          e.each(function () {
            ...
            a.attr('data-src')
              ? $(this).data('origin', c)
              : $(this).css('backgroundImage', 'url(' + c + ')'),
              $(this).data('thumb', c).height(b.height()),
              a.remove();
          }),
        e.width(b.width()),
        !(a.len <= 1))
        ...
        'slide' === f.animation &&
          (d.isSupportTransition &&
            (c.css(d.transformProperty, 'translate3d(0, 0, 0)'),
            c.css('transition', 'transform ' + f.duration + 'ms')),
          c.css('left', 0),
          e.css('float', 'left').first().show().siblings().hide(),
          e.first().clone(!0).addClass('first-clone').hide().appendTo(c),
          e.last().clone(!0).addClass('last-clone').hide().prependTo(c)),
          'fade' === f.animation &&
            c.before(c.clone(!0).css({ position: 'absolute', top: 0, left: 0 })),
          ('fade' !== f.animation && 'flash' !== f.animation) ||
            e.first().siblings().css('opacity', 0),
          a.defaultStyle(),
          a.addElement().arrow();
      }
    };
  ...
  (function (a, b) {
    'function' == typeof define && define.amd
      ? define(['global', 'banner'], function (c, d) {
          return b($, a, document, c, d);
        })
      : 'undefined' != typeof exports
      ? (module.exports = b($, a, document, require('global'), require('banner')))
      : ((a.terseBanner = a.terseBanner || {}),
        b($, a, document, a.terseBanner.Global, a.terseBanner.Banner));
  })(window, function (a, b, c, d, e) {
  ...
  (function (a, b) {
    ...
    e.prototype.setStyle = function (a) {
      ...
      switch (a) {
        case 'arrow':
          'none' === e.css('backgroundImage') &&
            (e.height() || e.height(parseInt(0.1 * c.height())),
            e.filter('.prev').html('<img src="' + d.prevArrow + '">'),
            e.filter('.next').html('<img src="' + d.nextArrow + '">'),
            e.find('img').on('dragstart', function () {
              return !1;
            }));
          break;
        case 'arrowBoxPos':
          'auto' === f.css('top') &&
            'auto' === f.css('bottom') &&
            f.css({ top: '50%', marginTop: -e.outerHeight() / 2 }),
            'auto' === f.css('left') &&
              'auto' === f.css('right') &&
              f.css({ left: '50%', marginLeft: -f.width() / 2 }),
            c.append(f.css('position', 'absolute'));
          break;
        case 'btnBoxPos':
          'auto' === h.css('top') && 'auto' === h.css('bottom') && h.css('bottom', 10),
            'auto' === h.css('left') &&
              'auto' === h.css('right') &&
              h.css({ left: '50%', marginLeft: (-g.outerWidth(!0) * g.length) / 2 }),
        ...
        case 'thumb':
          i.each(function () {
            ...
            i.css({ width: b.thumb.width, height: b.thumb.height, marginRight: b.thumb.gap }),
        ...
        case 'thumbSlideBtn':
          ...
          break;
        case 'thumbList':
          j.css({ left: 0, width: i.outerWidth(!0) * i.length - b.thumb.gap });
          break;
        case 'thumbBox':
          var m,
            n,
            o = i.outerWidth(!0);
          (m = $.isNumeric(b.thumb.visible)
            ? Math.min(b.thumb.visible, parseInt(c.width() / o))
            : parseInt(c.width() / o)),
            (n = o * m - b.thumb.gap),
            l.css({ left: '50%', width: n, height: j.height(), marginLeft: -n / 2 }),
            j.width() <= l.width()
              ? k.hide()
              : (k
                  .filter('.prev')
                  .css({ left: b.thumb.gap, backgroundImage: 'url(' + d.prevThumbBtn + ')' }),
                k
                  .filter('.next')
                  .css({ right: b.thumb.gap, backgroundImage: 'url(' + d.nextThumbBtn + ')' }));
      }
    };
  }),
  (function (a, b) {
    'function' == typeof define && define.amd
      ? define(['global', 'banner', 'set-style', 'bind-animation'], function (c, d) {
          return b($, a, document, c, d);
        })
      : 'undefined' != typeof exports
      ? (module.exports = b(
    ...
    e.prototype.addElement = function () {
      ...
      return {
        arrow: function () {
          return !e.arrow || d.isMobile
            ? void b.addElement().btn()
            : (c.append('<div class="tb-arrow"><a class="prev"></a><a class="next"></a></div>'),
              (b.$arrowBox = $('.tb-arrow', c)),
              (b.$arrow = $('.tb-arrow a', c)),
              b.setStyle('arrow'),
              b.setStyle('arrowBoxPos'),
              b.$arrow.on({
                click: function () {
                  b.isAnimated ||
                    (a(), $(this).hasClass('prev') ? b.currentIndex-- : b.currentIndex++, b.play());
                },
        ...
        btn: function () {
          ...
          c.append($('<div class="tb-btn"/>').append(g)),
            (b.$btnBox = $('.tb-btn', c)),
            (b.$btn = $('.tb-btn a', c)),
            b.$btn.first().addClass('active'),
            b.setStyle('btnBoxPos'),
            'ol' === e.btn &&
              b.$btn.find('i').each(function (a) {
                $(this).text(a + 1);
              }),
            d.isMobile ||
              b.$btn.on(b.options.useHover ? 'mouseenter' : 'click', function () {
        ...
        thumb: function () {
          if (
            !(
              'object' == typeof e.thumb &&
              parseInt(e.thumb.width) > 0 &&
              parseInt(e.thumb.height) > 0 &&
              parseInt(e.thumb.gap) >= 0
            )
          )
            return void b.bindAnimation();
          for (var d, f = 0, g = ''; f < b.len; f++)
            (d = b.thumbArr[f]), (g += '<dd><img src="' + d + '"></dd>');
          c.append(
            '<div class="tb-thumb"><dl>' +
              g +
              '</dl><a class="prev disabled"></a><a class="next"></a></div>',
          ),
            (b.$thumbBox = $('.tb-thumb', c)),
            (b.$thumbSlideBtn = $('.tb-thumb a', c)),
            (b.$thumbList = $('.tb-thumb dl', c)),
            (b.$thumb = $('.tb-thumb dl dd', c)),
            b.setStyle('thumb'),
            b.setStyle('thumbSlideBtn'),
            b.setStyle('thumbList'),
            b.setStyle('thumbBox'),
            b.$thumb.first().addClass('active'),
            b.$thumb.on(b.options.useHover ? 'mouseenter' : 'click', function () {
              b.isAnimated || (a(), (b.currentIndex = $(this).index()), b.play());
            }),
            b.$thumbSlideBtn.on({
              click: function () {
                if (!$(this).hasClass('disabled')) {
                  ...
                  (a = $.isNumeric(b.options.thumb.visible)
                    ? Math.min(b.options.thumb.visible, parseInt(c.width() / g.outerWidth(!0)))
                    : parseInt(c.width() / g.outerWidth(!0))),
                    (d = $(this).hasClass('prev')
                      ? Math.min(h + g.outerWidth(!0) * a, 0)
                      : Math.max(h - g.outerWidth(!0) * a, e.width() - f.width())),
                    b.animation.thumbListSlide(d);
                }
              },
              selectstart: function () {
                return !1;
  ...
  (function (a, b) {
    'function' == typeof define && define.amd
      ? define(['global', 'banner', 'bind-event'], function (c, d) {
          return b($, a, document, c, d);
        })
      : 'undefined' != typeof exports
      ? (module.exports = b(
    ...
    e.prototype.bindAnimation = function () {
      ...
      function b() {
        f.currentIndex =
          f.currentIndex === f.len ? 0 : f.currentIndex === -1 ? f.len - 1 : f.currentIndex;
      }
      var c,
        e,
        f = this,
      ...
      (o.slide = function () {
        var a = !0;
        f.currentIndex !== f.latestIndex &&
          (f.currentIndex < f.latestIndex && (a = !1),
          a === !1 && i.css('left', '-100%'),
          j.eq(f.currentIndex + 1).show(),
          d.isSupportTransition &&
            setTimeout(function () {
              f.isAnimated = !0;
              var b = a
                ? 'translate3d(' + -j.width() + 'px, 0, 0)'
                : 'translate3d(' + j.width() + 'px, 0, 0)';
              i.css(d.transformProperty, b), setTimeout(f.animation.slideCallback, g.duration - 50);
            }, 50),
          d.isSupportTransition ||
            ((f.isAnimated = !0),
            i.animate({ left: a ? '-100%' : 0 }, g.duration, f.animation.slideCallback)),
          f.activeBtnAndThumb());
      }),
        (o.fade = function () {
          b(),
            (f.isAnimated = !0),
            i.css('left', 100 * -f.currentIndex + '%'),
            j
              .eq(f.currentIndex)
              .animate(
                { opacity: 1 },
                { duration: 0.8 * g.duration, complete: f.animation.fadeCallback },
              ),
            f.activeBtnAndThumb();
        }),
        (o.flash = o.fade),
        (o.none = function () {
          b(),
            j.eq(f.currentIndex).show().siblings().hide(),
            f.activeBtnAndThumb(),
            j.eq(f.currentIndex).data('origin') || a();
        }),
        (o.thumbListSlide = function () {
          l.is(':animated') ||
            ((c = $.isNumeric(g.thumb.visible)
              ? Math.min(g.thumb.visible, parseInt(h.width() / m.outerWidth(!0)))
              : parseInt(h.width() / m.outerWidth(!0))),
            (e = $.isNumeric(arguments[0])
              ? arguments[0]
              : Math.max(
                  -parseInt(f.activeIndex / c) * m.outerWidth(!0) * c,
                  k.width() - l.width(),
                )),
            l.stop(!0, !1).animate({ left: e }, function () {
              var a = parseInt(l.css('left'));
              a
                ? Math.abs(a) + k.width() === l.width()
                  ? n.filter('.next').addClass('disabled').siblings('a').removeClass('disabled')
                  : n.removeClass('disabled')
                : n.filter('.prev').addClass('disabled').siblings('a').removeClass('disabled');
            }));
        }),
        (o.slideCallback = function () {
          (f.isAnimated = !1),
            (f.latestIndex = f.currentIndex =
              f.currentIndex === -1 ? f.len - 1 : f.currentIndex === f.len ? 0 : f.currentIndex),
            i.css({ left: 0, transition: 'none' }),
            i.css(d.transformProperty, 'translate3d(0, 0, 0)'),
            j
              .eq(f.currentIndex + 1)
              .show()
              .siblings()
            ...
            j.eq(f.currentIndex).data('origin') || a(),
            f.useAuto && !f.isHovered && f.setPlayTimer();
        }),
        (o.fadeCallback = function () {
          (f.isAnimated = !1),
            'fade' === g.animation &&
              (i.prev().css('left', 100 * -f.currentIndex + '%'), i.prev().html(i.html())),
            j.eq(f.currentIndex).siblings().css('opacity', 0),
            j.eq(f.currentIndex).data('origin') || a(),
            f.useAuto && !f.isHovered && f.setPlayTimer();
        }),
        setTimeout(function () {
          g.before.call(f, f.$elem, f.$item, 0),
            f.currentIndex || j.eq(f.currentIndex).data('origin') || a();
        }, 50),
        f.bindEvent().widthChangeEvent(),
        f.bindEvent().touchEvent();
    };
  }),
  (function (a, b) {
    'function' == typeof define && define.amd
      ? define(['global', 'banner', 'lazyload'], function (c, d) {
          return b($, a, document, c, d);
        })
      : 'undefined' != typeof exports
      ? (module.exports = b(
      ...
      return {
        widthChangeEvent: function () {
          setInterval(function () {
            n.width(l.width()),
              k.adaptive && (m.height(n.filter(':visible').height()), l.height(m.height())),
              'fade' === k.animation && m.prev().children().width(l.width()),
              k.arrow &&
                j.$arrowBox.css('marginLeft', function () {
                  return -j.$elem.width() / 2;
                });
          }, 50),
            $.isNumeric(k.auto) && k.auto > 0 && ((j.useAuto = !0), j.setPlayTimer()),
            j.lazyload();
        },
        touchEvent: function () {
          function o(d) {
            d.preventDefault(),
              j.isAnimated ||
                ((a = d.touches[0]), (b = Date.now()), (c = a.pageX - l.offset().left));
          }
          function p(b) {
            if ((b.preventDefault(), !j.isAnimated)) {
              if (
                ((a = b.touches[0]),
                (e = a.pageX - l.offset().left),
                (f = e - c),
                k.before.call(j, j.$elem, j.$item, j.currentIndex),
                !m.hasClass('touching'))
              ) {
                ...
                g === !1 && m.css('left', '-100%'),
                  n.eq(j.currentIndex + 1).show(),
                  m.addClass('touching');
              }
              m.css(d.transformProperty, 'translate3d(' + f + 'px, 0, 0)'),
                j.lazyload(j.currentIndex);
            }
          }
          function q(a) {
            if ((a.preventDefault(), !j.isAnimated && f)) {
              ...
              var c;
              (h < 300 || Math.abs(f) >= n.width() / 2) &&
                ((c = g
                  ? 'translate3d(' + -n.width() + 'px, 0, 0)'
                  : 'translate3d(' + n.width() + 'px, 0, 0)'),
                j.activeBtnAndThumb()),
                h > 300 &&
                  Math.abs(f) < n.width() / 2 &&
                  ((c = 'translate3d(0, 0, 0)'), g ? j.currentIndex-- : j.currentIndex++),
                m.removeClass('touching').css(d.transformProperty, c),
                setTimeout(function () {
          ...
          d.isSupportTouch &&
            (l[0].addEventListener('touchstart', o, !1),
            l[0].addEventListener('touchmove', p, !1),
            l[0].addEventListener('touchend', q, !1));
        },
      };
    };
  }),
  (function (a, b) {
    ...
    e.prototype.lazyload = function () {
      ...
      function b() {
        function b() {
          'slide' === e.animation &&
            (e.adaptive && h.children().last().html(i.first().html()),
            h
              .children()
              .last()
              .attr('style', function () {
        ...
        if (
          (f === -1 && (j = h.children().first()),
          e.adaptive
            ? j.find('img[data-src]').attr('src', k)
            : j.css('backgroundImage', 'url(' + k + ')'),
          f)
        )
          j.data('origin', ''),
            g.find('.tb-loading').fadeOut(400, function () {
              $(this).remove();
            }),
            'slide' === e.animation &&
              (f === -1 &&
                (e.adaptive && i.last().html(h.children().first().html()),
                i
                  .last()
                  .attr('style', function () {
                  ...
                  .data('origin', '')),
              f === c.len - 1 &&
                (e.adaptive && h.children().first().html(i.last().html()),
                h
                  .children()
                  .first()
                  .attr('style', function () {
      ...
      if (k)
        if (f) {
          var l;
          l =
            'rgba(0, 0, 0, 0)' === g.css('backgroundColor') ||
            'transparent' === g.css('backgroundColor')
              ? '#fff'
              : g.css('backgroundColor');
          var m = '<div class="tb-loading"><img src="' + d.loadingImage + '"></div>';
          j.append(m),
            'slide' === e.animation && f === -1 && h.children().first().append(m),
            $('.tb-loading').css({ background: l, height: g.height() }),
  ...
  (function (a, b) {
    'function' == typeof define && define.amd
      ? define(['global', 'banner', 'init'], function (c, d) {
          return b($, a, document, c, d);
        })
      : 'undefined' != typeof exports
      ? (module.exports = b($, a, document, require('global'), require('banner'), require('init')))
      : ((a.terseBanner = a.terseBanner || {}),
        b($, a, document, a.terseBanner.Global, a.terseBanner.Banner));
  })(window, function (a, b, c, d, e) {
    (e.prototype.play = function () {
      ...
      (e.prototype.setPlayTimer = function () {
        ...
        clearInterval(a.playTimer),
          (a.playTimer = setInterval(function () {
            a.options.before.call(a, a.$elem, a.$item, a.currentIndex), a.currentIndex++, a.play();
          }, a.options.auto)),
          a.$elem.off('mouseenter'),
          a.$elem.off('mouseleave'),
          a.$elem.on({ mouseenter: b, mouseleave: c });
      }),
      (e.prototype.activeBtnAndThumb = function () {
        (this.activeIndex =
          ...
          this.$thumb &&
            ...
            this.$thumbSlideBtn.is(':visible') && this.animation.thumbListSlide());
      }),
      ...
      ($.fn.terseBanner = function (a) {
        ...
        return this.each(function () {
          ...
          b
            ? 'prev' === a
              ? b.switchTo.call(b, 'prev')
              : 'next' === a
              ? b.switchTo.call(b, 'next')
              : $.isNumeric(a) && b.switchTo.call(b, a)
            : ((options = $.extend(!0, {}, $.fn.terseBanner.defaults, 'object' == typeof a && a)),
              $(this).data('terseBanner', (b = new e(this, options))),
              b.init());
        });
      }),
